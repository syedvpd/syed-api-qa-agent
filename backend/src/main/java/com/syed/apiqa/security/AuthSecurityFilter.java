...
public class AuthSecurityFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return path.equals("/api/health") || path.equals("/health") || path.equals("/actuator/health") || path.equals("/") || path.startsWith("/api/auth/") || path.startsWith("/api/specs/") || !path.startsWith("/api/");
    }
